...
3. Open the project in your work environment (I worked on it in Visual Code) and run the application (in VSCode I use
`./mvnw spring-boot:run`
)
4. Run the tests from Postman and review the code
5. Give your rating. Thanks!
